...
export default function Header() {
  ...
  return (
    <>
      <header
        id="main-header"
        className="sticky top-0 z-50 border-b border-slate-200 shadow-sm w-full"
      >
        <div className="absolute inset-0 -z-10 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm" />
        <div className="mx-auto max-w-7xl px-4 py-3">
          <div className="flex md:hidden justify-between items-center w-full">
            <div className="flex items-center">
              <div className="relative z-60 mr-2 p-1">
                <HamburgerButton
                ...
                {!isAuthenticated ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="cursor-pointer w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-red-600 hover:bg-red-50 font-medium text-sm transition"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
